...
## 🆕 Recent Updates
* **UX Improvements:** Added responsive loading states (spinners and disabled buttons) to the Login and Registration pages to gracefully handle delays caused by the free-tier backend's cold starts.
